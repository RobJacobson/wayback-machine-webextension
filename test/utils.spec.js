...
const getUrlByParameter =
  require("../webextension/scripts/utils").getUrlByParameter;
...
const isNotExcludedUrl =
  require("../webextension/scripts/utils").isNotExcludedUrl;
const badgeCountText = require("../webextension/scripts/utils").badgeCountText;
const timestampToDate =
  require("../webextension/scripts/utils").timestampToDate;
const dateToTimestamp =
  require("../webextension/scripts/utils").dateToTimestamp;
...
describe("twitter", () => {
  it("should extract correct tweet url", () => {
    dom.reconfigure({
      url: "chrome-extension://hkahpanhaccgppbidkekeijffcdppdan/twitter.html?url=https://archive.org/",
    });
...
describe("getCleanUrl", () => {
  var test_cases = [
    ...
    {
      url: "https://www.amazon.in/End-Days-Predictions-Prophecies-Thorndike/dp/1410407462",
      result:
        "https://www.amazon.in/End-Days-Predictions-Prophecies-Thorndike/dp/1410407462",
    },
    {
      url: "http://purl.oclc.org/docs/inet96.html",
      result: "http://purl.oclc.org/docs/inet96.html",
    },
    { url: "https://apnews.com/", result: "https://apnews.com/" },

    // Test Cases when the URL includes 'web.archive.org'
    {
      url: "https://web.archive.org/web/*/https://www.google.com/",
      result: "https://www.google.com/",
    },
    {
      url: "https://web.archive.org/web/*/https://www.amazon.in/End-Days-Predictions-Prophecies-Thorndike/dp/1410407462",
      result:
        "https://www.amazon.in/End-Days-Predictions-Prophecies-Thorndike/dp/1410407462",
    },
    {
      url: "https://web.archive.org/web/*/http://purl.oclc.org/docs/inet96.html",
      result: "http://purl.oclc.org/docs/inet96.html",
    },
    {
      url: "https://web.archive.org/web/*/https://apnews.com/",
      result: "https://apnews.com/",
    },
    {
      url: "https://web.archive.org/web/20200205001304/https://www.google.com/",
      result: "https://www.google.com/",
    },
    {
      url: "https://web.archive.org/web/20200602155930/https://www.amazon.in/End-Days-Predictions-Prophecies-Thorndike/dp/1410407462",
      result:
        "https://www.amazon.in/End-Days-Predictions-Prophecies-Thorndike/dp/1410407462",
    },
    {
      url: "https://web.archive.org/web/20200215123917/http://purl.oclc.org/docs/inet96.html",
      result: "http://purl.oclc.org/docs/inet96.html",
    },
    {
      url: "https://web.archive.org/web/20200308013652/https://apnews.com/",
      result: "https://apnews.com/",
    },

    // Test for Extension Pages
    {
      url: "moz-extension://abcd-1234-efghi/annotations.html?url=https://example.com/",
      result: "https://example.com/",
    },
    {
      url: "moz-extension://abcd-1234-efghi/annotations.html?url=http://example.com/1234",
      result: "http://example.com/1234",
    },
    {
      url: "chrome-extension://abcd-1234-efghi/annotations.html?url=https://example.com/",
      result: "https://example.com/",
    },
    {
      url: "chrome-extension://abcd-1234-efghi/annotations.html?url=http://example.com/1234",
      result: "http://example.com/1234",
    },
  ];
  test_cases.forEach(({ url, result }) => {
...
describe("isNotExcludedUrl", () => {
  var test_cases = [
    ...
    {
      url: "chrome-extension://qwertyuiop/example.html?url=https://www.example.com/",
      result: false,
    },
    { url: "chrome://extensions", result: false },
...
describe("timestampToDate", () => {
  let test_cases = [
    ...
    {
      timestamp: "19981205021324",
      result: new Date(Date.UTC(1998, 11, 5, 2, 13, 24)),
    },
    {
      timestamp: "20010105131425",
      result: new Date(Date.UTC(2001, 0, 5, 13, 14, 25)),
    },
    {
      timestamp: "20010905131400",
      result: new Date(Date.UTC(2001, 8, 5, 13, 14, 0)),
    },
    {
      timestamp: "20010105130000",
      result: new Date(Date.UTC(2001, 0, 5, 13, 0, 0)),
    },
    {
      timestamp: "20011130000000",
      result: new Date(Date.UTC(2001, 10, 30, 0, 0, 0)),
    },
    {
      timestamp: "200101050000",
      result: new Date(Date.UTC(2001, 0, 5, 0, 0, 0)),
    },
    {
      timestamp: "2001010500",
      result: new Date(Date.UTC(2001, 0, 5, 0, 0, 0)),
    },
  ...
  test_cases.forEach(({ timestamp, result }) => {
    it(
      "should return " +
        (result ? result.toUTCString() : "null") +
        " on " +
        timestamp,
      () => {
...
describe("dateToTimestamp", () => {
  let test_cases = [
    ...
    {
      result: "19981205021324",
      date: new Date(Date.UTC(1998, 11, 5, 2, 13, 24)),
    },
    {
      result: "20010105131425",
      date: new Date(Date.UTC(2001, 0, 5, 13, 14, 25)),
    },
    {
      result: "20010905131400",
      date: new Date(Date.UTC(2001, 8, 5, 13, 14, 0)),
    },
    {
      result: "20010105130000",
      date: new Date(Date.UTC(2001, 0, 5, 13, 0, 0)),
    },
    {
      result: "20011130000000",
      date: new Date(Date.UTC(2001, 10, 30, 0, 0, 0)),
    },
...
describe("makeValidURL", () => {
  var test_cases = [
    ...
    {
      url: "purl.oclc.org/docs/inet96.html",
      result: "https://purl.oclc.org/docs/inet96.html",
    },
...
describe("cropPrefix", () => {
  var test_cases = [
    ...
    {
      url: "https://foo.example.com/foo/bar?baz#buz",
      result: "foo.example.com/foo/bar?baz#buz",
    },
    {
      url: "http://foo.example.com/foo/bar?baz#buz",
      result: "foo.example.com/foo/bar?baz#buz",
    },
    { url: "www.example.com/www/foo.html", result: "example.com/www/foo.html" },
    { url: "www.example.com/www.html", result: "example.com/www.html" },
    {
      url: "http://example.com/www/foo.html",
      result: "example.com/www/foo.html",
    },
    ...
    {
      url: "https://example.com/foo/https://www.example.org/",
      result: "example.com/foo/https://www.example.org",
    },
    { url: "", result: "" },
...
describe("cropScheme", () => {
  var test_cases = [
    ...
    {
      url: "www.example.com/www/foo.html",
      result: "www.example.com/www/foo.html",
    },
