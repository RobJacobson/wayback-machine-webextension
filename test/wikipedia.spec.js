...
describe("wikipedia.js extractISBN(url)", () => {
  let test_cases = [
    ...
    {
      url: "https://en.wikipedia.org/wiki/Special:BookSources/978-0-9783318-1-8",
      result: "9780978331818",
    },
    {
      url: "https://en.wikipedia.org/wiki/Special:BookSources/0-8129-2343-X",
      result: "081292343X",
    },
    {
      url: "https://fr.wikipedia.org/wiki/Sp%C3%A9cial:Ouvrages_de_r%C3%A9f%C3%A9rence/978-84-9761-902-8",
      result: "9788497619028",
    },
    {
      url: "https://fr.wikipedia.org/wiki/Sp%C3%A9cial:Ouvrages_de_r%C3%A9f%C3%A9rence/84-9761-902-1",
      result: "8497619021",
    },
    {
      url: "https://fr.wikipedia.org/wiki/Sp%C3%A9cial:Ouvrages_de_r%C3%A9f%C3%A9rence/2-904918-09-4",
      result: "2904918094",
    },
...
describe("wikipedia.js isWikipediaUrl(url)", () => {
  ...
  it("should reject non-strings", () => {
    let result =
      isWikipediaUrl(5) || isWikipediaUrl({}) || isWikipediaUrl(true);
