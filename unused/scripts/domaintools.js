  ...
  $.getJSON(domaintools_api, (data) => {
    ...
    if (data.status !== "error") {
      if (data.response.results_count !== 0) {
        appendToParent(
          "#domain",
          data.response.results[0].domain,
          "Domain: ",
          parent,
          true,
          "",
        ...
        appendToParent(
          ...
          data.response.results[0].admin_contact.country.value,
          "Country: ",
          parent,
          true,
          "",
        ...
        appendToParent(
          "#create_date",
          data.response.results[0].create_date.value,
          "Created Date: ",
          parent,
          true,
          "",
        ...
        appendToParent(
          "#email_domain",
          data.response.results[0].email_domain[0].value,
          "Email Domain: ",
          parent,
          true,
          "",
        ...
        appendToParent(
          "#expiration_date",
          data.response.results[0].expiration_date.value,
          "Expire Date: ",
          parent,
          true,
          "",
        ...
        appendToParent(
          "#admin_contact_state",
          data.response.results[0].admin_contact.state.value,
          "State: ",
          parent,
          true,
          "",
        ...
        appendToParent(
          "#registrant_org",
          data.response.results[0].registrant_org.value,
          "Registrant Org: ",
          parent,
          true,
          "",
        ...
        appendToParent(
          "#website_response",
          data.response.results[0].website_response,
          "Website Response Status Code: ",
          parent,
          true,
          "",
        );
        appendToParent(
          "#whois",
          data.response.results[0].whois_url,
          "Click to see the Whois URL",
          parent,
          false,
          "",
        );
...
if (typeof module !== "undefined") {
  module.exports = { appendToParent, getDomainTool };
}
